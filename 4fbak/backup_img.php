...
/*  p[6],p[7] O---------------------O p[4],p[5]
    ...
    if (debug){ print_r ($p); echo "<br>";
       echo "Text=".$text."<br>";
       echo "untere linke Ecke, X-Position  =".$p[0]."<br>";       echo "untere linke Ecke, Y-Position  =".$p[1]."<br>";       echo "untere rechte Ecke, X-Position =".$p[2]."<br>";
       echo "untere rechte Ecke, Y-Position =".$p[3]."<br>";       echo "obere rechte Ecke, X-Position  =".$p[4]."<br>";       echo "obere rechte Ecke, Y-Position  =".$p[5]."<br>";
       echo "obere linke Ecke, X-Position   =".$p[6]."<br>";       echo "obere linke Ecke, Y-Position   =".$p[7]."<br>";
...
/*******************************************************************************/
  function fixtext (){
    ...
    $this->draw_text (  75, 1070,  0, $this->color_sw, $this->fontsize01, "n", "u", "l", "Absender" );

    $this->draw_text ( 300, 1080,  0, $this->color_sw, $this->fontsize01, "n", "u", "l", "Einheit/Einrichtung/Stelle" );
    $this->draw_text ( 700, 1080,  0, $this->color_sw, $this->fontsize01, "n", "u", "l", "Zeichen" );
    $this->draw_text ( 900, 1080,  0, $this->color_sw, $this->fontsize01, "n", "u", "l", "Funktion" );
