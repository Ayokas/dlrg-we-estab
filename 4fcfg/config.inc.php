...
/*********               Do not change the folowing lines               **********/
  ...
  //  $conf_4f ["Version"]          =  "v0.9.22 19.01.2012";
      // Hier kann die eigene Dienststelle eingetragen werden Zeilenumbruch mit <br>
    $conf_4f ["Stelle"]           =  "Einsatzleitung - DLRG Westfalen" ;
  ...
  //  $conf_4f ["NameVersion"][11]  = "lade-/speicherbare Funktionsmatrix Teil 1 <br>\n";
    ...
    $conf_4f ["NameVersion"][12]  = "(C) 2005-2012 HaJo Landmesser<br>eMail: info@eStab.de <br>\n";
    $conf_4f ["NameVersion"][13]  = "Infos, Forum unter  http://www.eStab.de <br>\n";
	$conf_4f ["NameVersion"][14]  = ". <br>\n";
	$conf_4f ["NameVersion"][15]  = ". <br>\n";
	$conf_4f ["NameVersion"][16]  = ". <br>\n";
    $conf_4f ["NameVersion"][17]  = "ACHTUNG es muss sich erst der SICHTER anmelden <br>\n";
